 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
  ...
  <!-- Fin Navbar -->
        ...
        <div id="content" class="bg-grey w-100 ml-2"> 
            ...
            <select id="miLista" onchange="redirigir()">
             <option value="1">parqueo 1</option>
             <option value="1">parqueo 2</option>
             <option value="3">Parqueo 3</option>
            </select>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
        ...
        <script>
            function redirigir() {
              ...
              window.location.href = "informacion.php?id=" + valorSeleccionado;
            }
        </script>
